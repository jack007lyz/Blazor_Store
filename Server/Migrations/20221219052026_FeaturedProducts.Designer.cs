...
namespace J7zECommerce.Server.Migrations
{
    ...
    [Migration("20221219052026_FeaturedProducts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("J7z_E_Commerce.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("J7z_E_Commerce.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("J7z_E_Commerce.Shared.ProductVariant", b =>
                {
                    b.HasOne("J7z_E_Commerce.Shared.Product", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("J7z_E_Commerce.Shared.ProductType", "ProductType")
                        .WithMany()
